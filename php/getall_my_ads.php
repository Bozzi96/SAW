<?php
    ...
    /*
    Questo script ottiene dal database tutti gli annunci dell'utente loggato,
    li converte in JSON e li passa allo script JS che li visualizza nell'elenco.
    */
    ...
    # Preparazione della query: non ci sono input "esterni" da inserire
    $stmt = $conn -> prepare("
